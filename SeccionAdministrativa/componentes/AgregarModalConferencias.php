        ...
        <br>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="inputname" name="inputname" placeholder="T&iacute;tulo de la conferencia"/>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" name="urlconfe" id="urlvideo" placeholder="Es requerido un link a un video de YouTube" />

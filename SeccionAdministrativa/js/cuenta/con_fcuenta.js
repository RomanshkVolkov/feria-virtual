$(document).ready(function () {
    $("#bEnviar").click(function () {
        ...
        if (
            ...
            $.post("GestionCuenta/updatecuenta.php", postData, function (response) {
                a = response;
                console.log(a);
                ...
                $("#CContrasena").val("");
                b = "Fallo al actualizar datos";
                c = "Usuario no disponible";
            ...
            $("#toast-body").html("Fallo al actualizar datos");
            $('.toast').toast('show');
            return false;
        }
    });
